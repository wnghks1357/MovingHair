          ...
          <div class="card card-signin my-5">
            <div class="card-body">
              ...
              <form class="form-signin" action="loginProc.do" method="POST" id="loginForm" name="loginForm" onsubmit="return false;">
                ...
                <button class="btn btn-lg btn-primary btn-block text-uppercase" type="button" style="width: 47%; float:left;" onclick="location.href='mhCustomerJoinAgree.do'">Join Us</button>
