...
<html lang="en">
  <head>
    ...
    <link rel='stylesheet' href='/stylesheets/bootstrap/login_boot.css' />
    <script src="/javascripts/bootstrap/jquery-3.2.1.min.js" charset="utf-8"></script>
  ...
  <body>
    <img src="resources/images/movinghair/movinghairLogo.PNG" style="margin-left: 43%; margin-top: 30px;">
          ...
          <div class="card card-signin my-5">
            <div class="card-body">
              ...
              <form class="form-signin" action="/users/loginProc" method="POST" id="loginForm" name="loginForm">
                ...
                <!-- 패스워드일치 여부 확인 -->
                <input type="hidden" id="pwConfirm" value="${pwConfirm }" />
              </form>
            </div>
          </div>
        </div>
